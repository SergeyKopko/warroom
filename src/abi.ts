...
export const gameAbi = parseAbi([
  ...
  'function rounds(uint256 roundId) view returns (uint128 reward, uint128 totalWeight, uint64 closedAt)',
  'function roundWeightOf(uint256 roundId, uint256 tokenId) view returns (uint256)',
  'function rewardClaimed(uint256 roundId, uint256 tokenId) view returns (bool)',
