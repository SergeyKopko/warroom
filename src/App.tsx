...
export default function App() {
  ...
  return (
    <div id="app">
      ...
      {rosterOpen && <RosterModal state={state} selected={selected} onClose={() => setRosterOpen(false)} onSelect={(id) => { actions.select(id); setRosterOpen(false) }} onMint={() => { setRosterOpen(false); openMint() }} onRevoke={actions.revokeWarAllowance} />}
    </div>
  )
}
